package com.dreamfirestudios.dreamauth.PlayerCommand;
...
import com.dreamfirestudios.dreamauth.SmartInvs.DreamfireAuthCoreMenu;
...
@PulseAutoRegister
public class DreamfireAuthPlayerCommand extends PlayerCommand {
    public DreamfireAuthPlayerCommand() {
        super("custombungee", false);
    }
    ...
    public void TimeStealCoreMethod(UUID playerID){
        ...
        DreamfireAuthPermissions.ReturnStaticAsync(DreamfireAuthPermissions.class, craftLegendsCorePermissions -> {
            ...
            new DreamfireAuthCoreMenu(player);
    ...
    public void TimeStealCoreSerializeItemMethod(UUID playerUUID, String itemName){
        ...
        DreamfireAuthPermissions.ReturnStaticAsync(DreamfireAuthPermissions.class, craftLegendsCorePermissions -> {
            ...
            DreamfireAuthAPI.SerializeItem(itemName, player.getInventory().getItemInMainHand());
            DreamfireAuthMessages.ReturnStaticAsync(DreamfireAuthMessages.class, craftLegendsCoreMessages -> {
